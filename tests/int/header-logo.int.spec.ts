...
describe('DexMetalHeader', () => {
  it('shows the supplied DexMetal logo enlarged inside a fixed-height responsive crop', () => {
    ...
    expect(logo!.parentElement?.classList.contains('overflow-hidden')).toBe(true)
