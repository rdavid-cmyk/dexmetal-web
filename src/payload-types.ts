...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "knowledge-hub-pages".
 */
export interface KnowledgeHubPage {
  id: number;
  title: string;
  slug: string;
  section:
    ...
    | 'API'
    | 'Shell';
  pageType: 'guide' | 'reference' | 'index' | 'tool' | 'landing' | 'static';
  priority?: ('P1' | 'P2') | null;
  content?: {
    root: {
      type: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'knowledge-hub-pages';
        value: number | KnowledgeHubPage;
      } | null)
    | ({
        relationTo: 'tools';
        value: number | Tool;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "knowledge-hub-pages_select".
 */
export interface KnowledgeHubPagesSelect<T extends boolean = true> {
  title?: T;
  slug?: T;
  section?: T;
  pageType?: T;
