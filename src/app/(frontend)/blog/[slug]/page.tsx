...
export default async function BlogSlugPage({ params }: Args) {
  ...
  const useEditorialPilot = post.slug === 'the-waste-that-cannot-leave'
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#1C1B18' }}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* Main Content */}
            <div className={`flex-1 min-w-0${useEditorialPilot ? ' blog-editorial-pilot' : ''}`}>
              ...
              {/* Main Content Body */}
              <div className={`blog-content${useEditorialPilot ? ' blog-content-editorial' : ''}`}>
