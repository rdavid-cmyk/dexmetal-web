    ...
    <article className="bg-dex-bg text-white">
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 18% 18%, rgba(29,158,117,0.18), transparent 32%), radial-gradient(circle at 82% 8%, rgba(194,116,69,0.16), transparent 28%), linear-gradient(180deg, #171812 0%, #11120f 72%, #191713 100%)',
          }}
        />
        <div
          aria-hidden="true"
        ...
        <svg
          data-route-map
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-8 h-[430px] w-full opacity-50 md:top-0 md:h-[560px]"
